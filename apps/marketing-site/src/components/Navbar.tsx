            ...
            <label className='modal-box w-11/12 max-w-7xl dark:bg-[#2C2C2C] -mt-60'>
              ...
              <div className='grid grid-cols-4 gap-4'>
                <div className='flex flex-row hover:bg-[#f8f9fd] dark:hover:bg-[#383838] pl-3 rounded-xl'>
                  ...
                  <span className='m-3'>
                    <div className='text-[#151515] dark:text-white cursor-pointer'>Getting Started</div>
                ...
                <div className='flex flex-row hover:bg-[#f8f9fd] dark:hover:bg-[#383838] pl-3 rounded-xl'>
                  ...
                  <span className='m-3'>
                    <div className='text-[#151515] dark:text-white cursor-pointer'>Browser Extension</div>
                    <div className='text-xs text-[#757685] cursor-pointer'>Learn more about app</div>
                  </span>
                </div>
                <div className='flex flex-row hover:bg-[#f8f9fd] dark:hover:bg-[#383838] pl-3 rounded-xl'>
                  ...
                  <span className='m-3'>
                    <div className='text-[#151515] dark:text-white cursor-pointer'>Generated Results</div>
                    <div className='text-xs text-[#757685] cursor-pointer'>Learn more about app</div>
                  </span>
                </div>
                <div className='flex flex-row hover:bg-[#f8f9fd] dark:hover:bg-[#383838] pl-3 rounded-xl'>
                  ...
                  <span className='m-3'>
                    <div className='text-[#151515] dark:text-white cursor-pointer'>API Reference</div>
                    <div className='text-xs text-[#757685] cursor-pointer'>Learn more about app</div>
                  </span>
                </div>
                <div className='flex flex-row hover:bg-[#f8f9fd] dark:hover:bg-[#383838] pl-3 rounded-xl'>
                  ...
                  <span className='m-3'>
                    <div className='text-[#151515] dark:text-white cursor-pointer'>Privacy and Security</div>
                    <div className='text-xs text-[#757685] cursor-pointer'>Learn more about app</div>
                  </span>
                </div>
                <div className='flex flex-row hover:bg-[#f8f9fd] dark:hover:bg-[#383838] pl-3 rounded-xl'>
                  ...
                  <span className='m-3'>
                    <div className='text-[#151515] dark:text-white cursor-pointer'>Perspectives</div>
                    <div className='text-xs text-[#757685] cursor-pointer'>Learn more about app</div>
                  </span>
                </div>
                <div className='flex flex-row hover:bg-[#f8f9fd] dark:hover:bg-[#383838] pl-3 rounded-xl'>
                ...
                <div className='flex flex-row hover:bg-[#f8f9fd] dark:hover:bg-[#383838] pl-3 rounded-xl'>
                  ...
                  <span className='m-3'>
                    <div className='text-[#151515] dark:text-white cursor-pointer'>Billing and Subscriptions</div>
                    <div className='text-xs text-[#757685] cursor-pointer'>Learn more about app</div>
                  </span>
                </div>
                <div className='flex flex-row hover:bg-[#f8f9fd] dark:hover:bg-[#383838] pl-3 rounded-xl'>
                  ...
                  <span className='m-3'>
                    <div className='text-[#151515] dark:text-white cursor-pointer'>Searching Connected Apps</div>
                    <div className='text-xs text-[#757685] cursor-pointer'>Learn more about app</div>
                  </span>
                </div>
                <div className='flex flex-row hover:bg-[#f8f9fd] dark:hover:bg-[#383838] pl-3 rounded-xl'>
                  ...
                  <span className='m-3'>
                    <div className='text-[#151515] dark:text-white cursor-pointer'>Briefings and Alerts</div>
                    <div className='text-xs text-[#757685] cursor-pointer'>Learn more about app</div>
                  </span>
                </div>
                <div className='flex flex-row hover:bg-[#f8f9fd] dark:hover:bg-[#383838] pl-3 rounded-xl'>
                  ...
                  <span className='m-3'>
                    <div className='text-[#151515] dark:text-white cursor-pointer'>Contributing to Find</div>
                    <div className='text-xs text-[#757685] cursor-pointer'>Learn more about app</div>
                  </span>
                </div>
                <div className='flex flex-row hover:bg-[#f8f9fd] dark:hover:bg-[#383838] pl-3 rounded-xl'>
