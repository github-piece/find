    ...
    <div className="max-w-[600px] mx-auto w-full">
      ...
      <div className="max-w-[480px] mx-auto">
        <p className="text-gray-400 sm:text-lg text-sm mb-12 font-semibold mb-8">
          Your master password is the only way to access your Find account.
          It&apos;s used to end-to-end encrypt your private data. Use a strong
          password and keep it a secret.
        </p>
        ...
        <div className="bg-gray-100 dark:bg-gray-100-dark text-gray-500 dark:text-gray-500-dark py-3 px-4 text-center rounded text-sm flex mt-3">
          ...
          <div className="mr-auto text-left">
            Be sure to save your Master Password securely. If you forget your
            Master Password, you won&apos;t be able to login. Find uses
            end-to-end encryption, so we can&apos;t reset your Master Password.
          </div>
        </div>
      </div>
    </div>
